...
def geo_area_def(scene):
    ...
    geo_area_defs = {
        ...
        'Goes_East': create_area_def('Goes_East', web_mercator_default, resolution=2000, area_extent=[-16698000, -12516000, 0.0, 12516000], units='meters'), #[-150, -74, 0, 74]
        ...
        'Meteo_IndOcean': create_area_def('Meteo_IndOcean', web_mercator_default, resolution=2000, area_extent=[-3898000, -12516000, 12802000, 12516000], units='meters'), #[-35, -74, 115, 74]
        'Himawari': create_area_def('Himawari', web_mercator_180deg, resolution=2000, area_extent=[-12802000, -12516000, 3898000, 12516000], units='meters') #[+65, -74, -145, 74]
    }
